...
CREATE TABLE IF NOT EXISTS scratch.american_express_eptrn_adjustment(
  AMEX_PAYEE_NUMBER          NUMERIC(18, 0) ENCODE ZSTD,
  AMEX_SE_NUMBER             NUMERIC(18, 0) ENCODE ZSTD,
  SE_UNIT_NUMBER             VARCHAR(10) ENCODE ZSTD,
  PAYMENT_YEAR               NUMERIC(4, 0) ENCODE ZSTD,
...
CREATE TABLE IF NOT EXISTS scratch.american_express_epape_pricing (
  SETTLEMENT_SE_ACCOUNT_NUMBER NUMERIC(18, 0) ENCODE ZSTD,
  SETTLEMENT_CURRENCY_CODE     VARCHAR(3) ENCODE ZSTD,
  RECORD_CODE                  VARCHAR(1) ENCODE RUNLENGTH,
  RECORD_SUB_CODE              VARCHAR(2) ENCODE RUNLENGTH,
  PRICING_DESCRIPTION          VARCHAR(64) ENCODE ZSTD,
  DISCOUNT_RATE                NUMERIC(18, 5) ENCODE ZSTD,
  FEE_PER_CHARGE               NUMERIC(18, 2) ENCODE ZSTD,
  NUMBER_OF_CHARGES            NUMERIC(18, 0) ENCODE ZSTD,
  GROSS_AMOUNT                 NUMERIC(18, 2) ENCODE ZSTD,
  GROSS_DEBIT_AMOUNT           NUMERIC(18, 2) ENCODE ZSTD,
  GROSS_CREDEIT_AMOUNT         NUMERIC(18, 2) ENCODE ZSTD,
  DISCOUNT_FEE                 NUMERIC(18, 2) ENCODE ZSTD,
  SERVICE_FEE                  NUMERIC(18, 2) ENCODE ZSTD,
  NET_AMOUNT                   NUMERIC(18, 2) ENCODE ZSTD,
  GENERATED_PAYMENT_NUMBER     VARCHAR(36) ENCODE ZSTD DISTKEY,
