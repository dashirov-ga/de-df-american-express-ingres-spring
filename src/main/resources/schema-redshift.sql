...
CREATE TABLE IF NOT EXISTS scratch.american_express_epape_record_of_charges (
  ...
  RECORD_TYPE                           VARCHAR(1) ENCODE RUNLENGTH,
  DETAIL_RECORD_TYPE                    VARCHAR(2) ENCODE RUNLENGTH,
  CHARGE_AMOUNT                         NUMERIC(18, 2) ENCODE ZSTD,
...
CREATE TABLE IF NOT EXISTS scratch.american_express_cbnot_chargeback (
  RECORD_TYPE                         VARCHAR(1) ENCODE RUNLENGTH,
  SE_ACCOUNT_NUMBER                   NUMERIC(18, 0) ENCODE ZSTD,
  CARD_MEMBER_ACCOUNT_NUMBER          VARCHAR(19) ENCODE ZSTD,
  CURRENT_CASE_NUMBER                 VARCHAR(11) ENCODE ZSTD,
  CURRENT_ACTION_NUMBER               VARCHAR(2) ENCODE ZSTD,
  PREVIOUS_CASE_NUMBER                VARCHAR(11) ENCODE ZSTD,
  PREVIOUS_ACTION_NUMBER              VARCHAR(2) ENCODE ZSTD,
  RESOLUTION                          VARCHAR(1) ENCODE ZSTD,
  FROM_SYSTEM                         VARCHAR(1) ENCODE ZSTD,
  REJECTS_TO_SYSTEM                   VARCHAR(1) ENCODE ZSTD,
  DISPUTES_TO_SYSTEM                  VARCHAR(1) ENCODE ZSTD,
  DATE_OF_ADJUSTMENT                  DATE ENCODE ZSTD,
  DATE_OF_CHARGE                      DATE ENCODE ZSTD,
  AMEX_ID                             VARCHAR(7) ENCODE ZSTD,
  CASE_TYPE                           VARCHAR(6) ENCODE ZSTD,
  LOCATION_NUMBER                     VARCHAR(15) ENCODE ZSTD,
  CHARGEBACK_REASON_CODE              VARCHAR(3) ENCODE ZSTD,
  CHARGEBACK_AMOUNT                   NUMERIC(18, 2) ENCODE ZSTD,
  CHARGEBACK_ADJUSTMENT_NUMBER        VARCHAR(6) ENCODE ZSTD,
  CHARGEBACK_RESOLUTION_ADJ_NUMBER    VARCHAR(6) ENCODE ZSTD,
  CHARGEBACK_REFERENCE_CODE           VARCHAR(12) ENCODE ZSTD DISTKEY,
  BILLED_AMOUNT                       NUMERIC(18, 2) ENCODE ZSTD,
  SOC_AMOUNT                          NUMERIC(18, 2) ENCODE ZSTD,
  SOC_INVOICE_NUMBER                  VARCHAR(6) ENCODE ZSTD,
  ROC_INVOICE_NUMBER                  VARCHAR(6) ENCODE ZSTD,
  FOREIGN_AMOUNT                      NUMERIC(18, 2) ENCODE ZSTD,
  CURRENCY                            VARCHAR(3) ENCODE ZSTD,
  SUPPORT_TO_FOLLOW                   VARCHAR(1) ENCODE ZSTD,
  CARD_MEMBER_NAME_1                  VARCHAR(30) ENCODE ZSTD,
  CARD_MEMBER_NAME_2                  VARCHAR(30) ENCODE ZSTD,
  CARD_MEMBER_ADDRESS_1               VARCHAR(30) ENCODE ZSTD,
  CARD_MEMBER_ADDRESS_2               VARCHAR(30) ENCODE ZSTD,
  CARD_MEMBER_CITY_STATE              VARCHAR(30) ENCODE ZSTD,
  CARD_MEMBER_ZIP_CODE                VARCHAR(9) ENCODE ZSTD,
  CARD_MEMBER_FIRST_NAME_1            VARCHAR(12) ENCODE ZSTD,
  CARD_MEMBER_MIDDLE_NAME_1           VARCHAR(12) ENCODE ZSTD,
  CARD_MEMBER_LAST_NAME_1             VARCHAR(20) ENCODE ZSTD,
  CARD_MEMBER_ORIGINAL_ACCOUNT_NUMBER VARCHAR(19) ENCODE ZSTD,
  CARD_MEMBER_ORIGINAL_NAME           VARCHAR(30) ENCODE ZSTD,
  CARD_MEMBER_ORIGINAL_FIRST_NAME     VARCHAR(12) ENCODE ZSTD,
  CARD_MEMBER_ORIGINAL_MIDDLE_NAME    VARCHAR(12) ENCODE ZSTD,
  CARD_MEMBER_ORIGINAL_LAST_NAME      VARCHAR(20) ENCODE ZSTD
  -- TODO: IMPLEMENT ADDITIONAL FIELDS

)
  DISTSTYLE KEY;

CREATE TABLE IF NOT EXISTS scratch.american_express_emcbk_chargeback (
  "RECORD_TYPE"                             VARCHAR(1) ENCODE RUNLENGTH,
  "DATA_TYPE"                               VARCHAR(5) ENCODE RUNLENGTH,
  "SERVICE_ESTABLISHMENT_NUMBER"            VARCHAR(10) ENCODE ZSTD,
  "CARD_NUMBER"                             VARCHAR(19) ENCODE ZSTD,
  "CASE_NUMBER"                             VARCHAR(16) ENCODE ZSTD,
  "CHARGEBACK_DATE"                         DATE ENCODE ZSTD DISTKEY,
  "CHARGEBACK_AMOUNT"                       NUMERIC(18, 2) ENCODE ZSTD,
  "CHARGEBACK_CURRENCY_CODE"                VARCHAR(3) ENCODE ZSTD,
  "CHARGEBACK_REASON_CODE"                  INTEGER ENCODE ZSTD,
  "ADJUSTMENT_REFERENCE_NUMBER"             VARCHAR(15) ENCODE ZSTD,
  "SOC_REFERENCE_NUMBER"                    VARCHAR(15) ENCODE ZSTD,
  "ROC_REFERENCE_NUMBER"                    VARCHAR(15) ENCODE ZSTD,
  "TRANSACTION_DATE"                        DATE ENCODE ZSTD,
  "TRANSACTION_AMOUNT"                      NUMERIC(18, 2) ENCODE ZSTD,
  "TRANSACTION_CURRENCY_CODE"               VARCHAR(3) ENCODE ZSTD,
  "SOC_DATE"                                DATE ENCODE ZSTD,
  "SOC_AMOUNT"                              NUMERIC(18, 2) ENCODE ZSTD,
  "AIRLINE_TICKET_NUMBER"                   VARCHAR(24) ENCODE ZSTD,
  "MICRO_SEQUENCE_NUMBER"                   INTEGER ENCODE ZSTD,
  "SETTLEMENT_SERVICE_ESTABLISHMENT_NUMBER" VARCHAR(10) ENCODE ZSTD,
  "SETTLEMENT_AMOUNT"                       NUMERIC(18, 2) ENCODE ZSTD,
  "SETTLEMENT_CURRENCY_CODE"                VARCHAR(3) ENCODE ZSTD,
  "SETTLEMENT_DATE"                         DATE ENCODE ZSTD,
  "CASE_UPDATE_FLAG"                        VARCHAR(1) ENCODE ZSTD, -- F=FIRST, L=LAST
  "CASE_UPDATE_TYPE"                        VARCHAR(2) ENCODE ZSTD, -- CR = Credit back, CA = Credit Adjustment, CB = Chargeback, CS = Chargeback stands, DB = Debit balance, DA = Debit Adjustment.
  "CASE_UPDATE_DATE"                        DATE ENCODE ZSTD,
  "SERVICE_ESTABLISHMENT_REPLY_BY_DATE"     DATE ENCODE ZSTD,
  "MERCHANT_INDUSTRY_TYPE_CODE"             VARCHAR(10) ENCODE ZSTD,
  "TERMINAL_ID"                             VARCHAR(10) ENCODE ZSTD,
  "SUBMISSION_CURRENCY_CODE"                VARCHAR(3) ENCODE ZSTD,
  "FIRST_PRESENTMENT_AMOUNT"                NUMERIC(18, 2) ENCODE ZSTD,
  "FIRST_PRESENTMENT_CURRENCY_CODE"         VARCHAR(3) ENCODE ZSTD,
  "TRANSACTION_ID"                          VARCHAR(50) ENCODE ZSTD PRIMARY KEY,
  "ACQUIRER_REFERENCE_NUMBER"               VARCHAR(23) ENCODE ZSTD,
  "ADDITIONAL_INFORMATION_TEXT_1"           VARCHAR(1130) ENCODE ZSTD,
  "ROC_REFERENCE_NUMBER_EXTENDED"           VARCHAR(30) ENCODE ZSTD,
  "CARD_MEMBER_NAME"                        VARCHAR(30) ENCODE ZSTD,
  "ADDITIONAL_INFORMATION_TEXT_2"           VARCHAR(440) ENCODE ZSTD,
  "SELLER_ID"                               VARCHAR(20) ENCODE ZSTD
)
  DISTSTYLE KEY;

CREATE TABLE IF NOT EXISTS scratch.american_express_eminq_inquiry (
  "RECORD_TYPE"                             VARCHAR(1) ENCODE RUNLENGTH,
  "DATA_TYPE"                               VARCHAR(5) ENCODE RUNLENGTH,
  "CARD_NUMBER"                             VARCHAR(19) ENCODE ZSTD,
  "CASE_NUMBER"                             VARCHAR(16) ENCODE ZSTD,
  "AIRLINE_TICKET_NUMBER"                   VARCHAR(24) ENCODE ZSTD,
  "TERMINAL_ID"                             VARCHAR(10) ENCODE ZSTD,
  "CASE_UPDATE_TYPE"                        VARCHAR(2) ENCODE RUNLENGTH,
  "CASE_UPDATE_DATE"                        DATE ENCODE ZSTD,
  "SERVICE_ESTABLISHMENT_REPLY_BY_DATE"     DATE ENCODE ZSTD,
  "TRANSACTION_DATE"                        DATE ENCODE ZSTD DISTKEY,
  "SERVICE_ESTABLISHMENT_NUMBER"            VARCHAR(10) ENCODE ZSTD,
  "TRANSACTION_CURRENCY_CODE"               VARCHAR(3) ENCODE ZSTD,
  "TRANSACTION_AMOUNT"                      NUMERIC(18, 2) ENCODE ZSTD,
  "FIRST_PRESENTMENT_CURRENCY_CODE"         VARCHAR(3) ENCODE ZSTD,
  "FIRST_PRESENTMENT_AMOUNT"                NUMERIC(18, 2) ENCODE ZSTD,
  "SOC_INVOICE_NUMBER"                      VARCHAR(15) ENCODE ZSTD,
  "SOC_DATE"                                DATE ENCODE ZSTD,
  "SOC_AMOUNT"                              NUMERIC(18, 2) ENCODE ZSTD,
  "ROC_REFERENCE_NUMBER"                    VARCHAR(15) ENCODE ZSTD,
  "SETTLEMENT_SERVICE_ESTABLISHMENT_NUMBER" VARCHAR(10) ENCODE ZSTD,
  ...
  "SETTLEMENT_AMOUNT"                       NUMERIC(18, 2) ENCODE ZSTD,
  "SETTLEMENT_DATE"                         DATE ENCODE ZSTD,
  "MICRO_SEQUENCE_NUMBER"                   VARCHAR(10) ENCODE ZSTD,
  "DISPUTE_REASON_CODE"                     INTEGER ENCODE ZSTD,
  "MERCHANT_INDUSTRY_TYPE_CODE"             VARCHAR(10) ENCODE ZSTD,
  "CHARGEBACK_CODE"                         VARCHAR(4) ENCODE ZSTD,
  "SOC_CURRENCY_CODE"                       VARCHAR(3) ENCODE ZSTD,
  "INQUIRY_CASE_COUNT"                      INTEGER ENCODE ZSTD,
  "SOURCE_SYSTEM_CODE"                      VARCHAR(3) ENCODE ZSTD,
  "TRANSACTION_ID"                          VARCHAR(50) ENCODE ZSTD PRIMARY KEY,
  "ACQUIRER_REFERENCE_NUMBER"               VARCHAR(23) ENCODE ZSTD,
  "ADDITIONAL_INFORMATION_TEXT_1"           VARCHAR(1130) ENCODE ZSTD,
  "ROC_REFERENCE_NUMBER_EXTENDED"           VARCHAR(30) ENCODE ZSTD,
  "ADDITIONAL_INFORMATION_TEXT_2"           VARCHAR(470) ENCODE ZSTD,
  "INQUIRY_MARKET_CODE"                     VARCHAR(3) ENCODE ZSTD,
  "SELLER_ID"                               VARCHAR(20) ENCODE ZSTD
)
  DISTSTYLE KEY;
