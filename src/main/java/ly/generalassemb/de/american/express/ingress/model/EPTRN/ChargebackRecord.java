...
public class ChargebackRecord {
    ...
    @Field(offset=21,length=10,align=Align.LEFT)        //  getServiceEstablishmentUnitNumber()
    ...
    @Field(offset=43,length=1,align=Align.LEFT)        //  getRecordType()
    ...
    @Field(offset=44,length=2,align=Align.LEFT)        //  getRecordSubType()
    ...
    @Field(offset=144,length=280,align=Align.LEFT)        //  getChargebackReason()
